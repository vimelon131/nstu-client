        ...
        <div className="page-wrap">
            <div className='container-main'>
                <div className="content">
                    ...
                    <p style={{fontSize: "20px"}}>Кафедра Автоматизированных систем управления факультета Автоматики и вычислительной техники Новосибирского государственного технического университета (НГТУ) проводит подготовку магистров по 2 направлениям:</p>
                    {specs}
                </div>
            </div>
